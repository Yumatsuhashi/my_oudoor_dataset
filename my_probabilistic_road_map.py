...
if __name__=="__main__":
    ...
    NUMBER_OF_VARIANTS = 20 # Number of pairs to generate (start and goal)
    start = (-30.0,10,Z)
    goal = (-5,-70,Z)
    ...
    output_file_path = "./Scenario/0626_s200_straight/s200_straight_paths_random_start_goal_no_smooth.csv"
    ...
    paths_meta_data_df.to_csv("./Scenario/0626_s200_straight/s200_straight_paths_random_start_goal_smoothed_meta_data.csv", index=False)
    ...
    df.to_csv("./Scenario/0626_s200_straight/s200_straight_paths_random_start_goal_smoothed.csv", index=False)
